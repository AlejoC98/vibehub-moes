...
const PickingForm = ({ defaultData, setOpenModal }: { defaultData?: PickingInput, setOpenModal?: (status: boolean) => void }) => {
    ...
    // const [pickingProducts, setPickingProducts] = useState<any
    // >();
